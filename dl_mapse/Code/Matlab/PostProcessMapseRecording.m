...
imageData = permute(hdfdata.tissue.data,[3 2 1]);
...
[mapseCycleEstimatesLeft, mapseMinIndicesLeft, mapseMaxIndicesLeft, interpMapseLeft, velocityMapseLeft] = PostProcessMapseCurve(mapseLeft, imageTimes, ecgPeakTimes, velocitySmoothLength);
[mapseCycleEstimatesRight, mapseMinIndicesRight, mapseMaxIndicesRight, interpMapseRight, velocityMapseRight] = PostProcessMapseCurve(mapseRight, imageTimes, ecgPeakTimes, velocitySmoothLength);
