...
h.plot.data=plot(x,y,'.','MarkerSize',50,'Parent',h_ax);
NextPlot=get(h_ax,'NextPlot');%get property to retain state
set(h_ax,'NextPlot','add')
h.plot.mean=plot(xxyy(1:2),mu*[1 1],'r','Parent',h_ax, 'LineWidth', 2);
h.plot.loa_lo=plot(xxyy(1:2),loa(1)*[1 1],'g--','Parent',h_ax, 'LineWidth', 2);
h.plot.loa_hi=plot(xxyy(1:2),loa(2)*[1 1],'g--','Parent',h_ax, 'LineWidth', 2);
if plotCI
